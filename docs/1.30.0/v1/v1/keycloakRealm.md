---
permalink: /1.30.0/v1/v1/keycloakRealm/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withOrganizationsEnabled(organizationsEnabled)`](#fn-specwithorganizationsenabled)
  ...
  * [`obj spec.login`](#obj-speclogin)
    * [`fn withDuplicateEmails(duplicateEmails)`](#fn-specloginwithduplicateemails)
    * [`fn withEditUsername(editUsername)`](#fn-specloginwitheditusername)
    * [`fn withEmailAsUsername(emailAsUsername)`](#fn-specloginwithemailasusername)
    * [`fn withForgotPassword(forgotPassword)`](#fn-specloginwithforgotpassword)
    * [`fn withLoginWithEmail(loginWithEmail)`](#fn-specloginwithloginwithemail)
    * [`fn withRememberMe(rememberMe)`](#fn-specloginwithrememberme)
    * [`fn withUserRegistration(userRegistration)`](#fn-specloginwithuserregistration)
    * [`fn withVerifyEmail(verifyEmail)`](#fn-specloginwithverifyemail)
...
### fn spec.withOrganizationsEnabled
...
### fn spec.login.withDuplicateEmails

```ts
withDuplicateEmails(duplicateEmails)
```

"DuplicateEmails allows multiple users to have the same email address."

### fn spec.login.withEditUsername

```ts
withEditUsername(editUsername)
```

"EditUsername allows to edit username."

### fn spec.login.withEmailAsUsername

```ts
withEmailAsUsername(emailAsUsername)
```

"EmailAsUsername allows users to set email as username."

### fn spec.login.withForgotPassword

```ts
withForgotPassword(forgotPassword)
```

"ForgotPassword shows a link on the login page for users who have forgotten their credentials."

### fn spec.login.withLoginWithEmail

```ts
withLoginWithEmail(loginWithEmail)
```

"LoginWithEmail allows users to log in with their email address."

### fn spec.login.withRememberMe
...
### fn spec.login.withUserRegistration
