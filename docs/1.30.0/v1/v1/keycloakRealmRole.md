---
permalink: /1.30.0/v1/v1/keycloakRealmRole/
---

# v1.v1.keycloakRealmRole
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withComposite(composite)`](#fn-specwithcomposite)
  * [`fn withComposites(composites)`](#fn-specwithcomposites)
  * [`fn withCompositesClientRoles(compositesClientRoles)`](#fn-specwithcompositesclientroles)
  * [`fn withCompositesClientRolesMixin(compositesClientRoles)`](#fn-specwithcompositesclientrolesmixin)
  * [`fn withCompositesMixin(composites)`](#fn-specwithcompositesmixin)
  * [`fn withDescription(description)`](#fn-specwithdescription)
  * [`fn withIsDefault(isDefault)`](#fn-specwithisdefault)
  * [`fn withName(name)`](#fn-specwithname)
  * [`obj spec.composites`](#obj-speccomposites)
    * [`fn withName(name)`](#fn-speccompositeswithname)
...
new returns an instance of KeycloakRealmRole
...
### fn spec.withCompositesClientRoles

```ts
withCompositesClientRoles(compositesClientRoles)
```

"CompositesClientRoles is a map of composites client roles assigned to role."

### fn spec.withCompositesClientRolesMixin

```ts
withCompositesClientRolesMixin(compositesClientRoles)
```
...
### fn spec.withCompositesMixin

```ts
withCompositesMixin(composites)
```
